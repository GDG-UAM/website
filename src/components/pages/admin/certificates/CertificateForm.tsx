...
export default function CertificateForm({
  ...
  const [data, setData] = useState<CertificateFormData>(() => ({
    ...
    autoGenerated: initial?.autoGenerated ?? false,
    teamId: initial?.teamId,
    hackathonId: initial?.hackathonId,
    memberId: initial?.memberId,
    originCertificateId: initial?.originCertificateId
  }));
  ...
  // Auto-fill group for Event Achievement if teamName is provided
  useEffect(() => {
    if (data.type === "EVENT_ACHIEVEMENT" && teamName) {
      updateMetadata("group", teamName);
    }
  }, [data.type, teamName]);
  ...
  const previewData: CertificateData = {
    ...
    type: data.type,
    recipient: teamMode ? { ...data.recipient, name: "{{name}}" } : data.recipient,
          ...
          <Section>
            ...
            <TwoCol>
              <TextField
                ...
                disabled={data.autoGenerated && !teamMode}
              />
              <TextField
                label={t("grade")}
          ...
          <Section>
            ...
            <TwoCol>
              ...
              <TextField
                ...
                disabled={(data.autoGenerated && !teamMode) || !!teamName}
              />
            </TwoCol>
          </Section>
        );
    ...
    <PageLayout>
      <FormColumn>
        <Form onSubmit={handleSubmit}>
          {data.autoGenerated && !teamMode && <Notice>{t("autoGeneratedNotice")}</Notice>}
          ...
          <Section>
            ...
            {teamMode ? (
              <Notice style={{ marginBottom: 0 }}>
                {t("controlledBySystem") ||
                  "This input is controlled by the system (Team Emission)"}
              </Notice>
            ) : (
              <>
                <TwoCol>
